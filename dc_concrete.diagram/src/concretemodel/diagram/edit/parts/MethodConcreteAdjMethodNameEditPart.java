...
import concretemodel.diagram.edit.policies.ConcretemodelTextSelectionEditPolicy;
 ...
 * @generated
 */
public class MethodConcreteAdjMethodNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public MethodConcreteAdjMethodNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new ConcretemodelTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return ConcretemodelElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConcretemodelParserProvider.getParser(ConcretemodelElementTypes.MethodConcreteAdj_3002,
					getParserElement(), ConcretemodelVisualIDRegistry
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(
					new TextDirectEditManager(this, null, ConcretemodelEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}

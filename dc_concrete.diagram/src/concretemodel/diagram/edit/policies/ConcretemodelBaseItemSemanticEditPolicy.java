 ...
 * @generated
 */
public class ConcretemodelBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	* @generated
	*/
	protected ConcretemodelBaseItemSemanticEditPolicy(IElementType elementType) {
	...
	public Command getCommand(Request request) {
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(ConcretemodelVisualIDRegistry.getVisualID((View) view));
	...
	*/
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = ConcretemodelElementTypes.getElementType(getVisualID(request));
	...
	*/
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = ConcretemodelDiagramEditorPlugin.getInstance().getLinkConstraints();
		if (cached == null) {
			ConcretemodelDiagramEditorPlugin.getInstance().setLinkConstraints(cached = new LinkConstraints());
		}
		return cached;
	}
	...
	public static class LinkConstraints {
		...
		*/
		 ...
		 * @generated
		 */
		public boolean canCreateContainmentSdj_4001(ClassDiagramAdj container, ClassConcreteAdj source,
				ClassConcreteAdj target) {
			return canExistContainmentSdj_4001(container, null, source, target);
		}

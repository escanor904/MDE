...
import concretemodel.diagram.edit.commands.AssociationAdj2CreateCommand;
import concretemodel.diagram.edit.commands.AssociationAdj2ReorientCommand;
...
import concretemodel.diagram.edit.commands.ContainmentSdj2CreateCommand;
import concretemodel.diagram.edit.commands.ContainmentSdj2ReorientCommand;
...
import concretemodel.diagram.edit.commands.GeneralizationAdj2CreateCommand;
import concretemodel.diagram.edit.commands.GeneralizationAdj2ReorientCommand;
...
import concretemodel.diagram.edit.commands.SharingAdj2CreateCommand;
import concretemodel.diagram.edit.commands.SharingAdj2ReorientCommand;
...
public class ClassConcreteAdjItemSemanticEditPolicy extends ConcretemodelBaseItemSemanticEditPolicy {
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (ConcretemodelVisualIDRegistry.getVisualID(incomingLink) == ContainmentSdj2EditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(incomingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
				continue;
			...
			if (ConcretemodelVisualIDRegistry.getVisualID(incomingLink) == SharingAdj2EditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(incomingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
				continue;
			...
			if (ConcretemodelVisualIDRegistry.getVisualID(incomingLink) == AssociationAdj2EditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(incomingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
				continue;
			...
			if (ConcretemodelVisualIDRegistry.getVisualID(incomingLink) == GeneralizationAdj2EditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(incomingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
				continue;
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (ConcretemodelVisualIDRegistry.getVisualID(outgoingLink) == ContainmentSdj2EditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(outgoingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
				continue;
			...
			if (ConcretemodelVisualIDRegistry.getVisualID(outgoingLink) == SharingAdj2EditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(outgoingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
				continue;
			...
			if (ConcretemodelVisualIDRegistry.getVisualID(outgoingLink) == AssociationAdj2EditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(outgoingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
				continue;
			...
			if (ConcretemodelVisualIDRegistry.getVisualID(outgoingLink) == GeneralizationAdj2EditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(outgoingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
				continue;
	...
	*/
	...
	protected Command getStartCreateRelationshipCommand(CreateRelationshipRequest req) {
		...
		if (ConcretemodelElementTypes.ContainmentSdj_4002 == req.getElementType()) {
			return getGEFWrapper(new ContainmentSdj2CreateCommand(req, req.getSource(), req.getTarget()));
		}
		...
		if (ConcretemodelElementTypes.SharingAdj_4004 == req.getElementType()) {
			return getGEFWrapper(new SharingAdj2CreateCommand(req, req.getSource(), req.getTarget()));
		}
		...
		if (ConcretemodelElementTypes.AssociationAdj_4006 == req.getElementType()) {
			return getGEFWrapper(new AssociationAdj2CreateCommand(req, req.getSource(), req.getTarget()));
		}
		...
		if (ConcretemodelElementTypes.GeneralizationAdj_4008 == req.getElementType()) {
			return getGEFWrapper(new GeneralizationAdj2CreateCommand(req, req.getSource(), req.getTarget()));
		}
		return null;
	}
	...
	protected Command getReorientRelationshipCommand(ReorientRelationshipRequest req) {
		...
		case ContainmentSdj2EditPart.VISUAL_ID:
			return getGEFWrapper(new ContainmentSdj2ReorientCommand(req));
		...
		case SharingAdj2EditPart.VISUAL_ID:
			return getGEFWrapper(new SharingAdj2ReorientCommand(req));
		...
		case AssociationAdj2EditPart.VISUAL_ID:
			return getGEFWrapper(new AssociationAdj2ReorientCommand(req));
		...
		case GeneralizationAdj2EditPart.VISUAL_ID:
			return getGEFWrapper(new GeneralizationAdj2ReorientCommand(req));
		}

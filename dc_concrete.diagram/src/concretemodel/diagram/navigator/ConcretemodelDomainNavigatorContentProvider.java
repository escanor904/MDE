 ...
 * @generated
 */
public class ConcretemodelDomainNavigatorContentProvider implements ICommonContentProvider {
	...
	* @generated
	*/
	public ConcretemodelDomainNavigatorContentProvider() {
	...
	*/
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof ConcretemodelDomainNavigatorItem) {
			return wrapEObjects(myAdapterFctoryContentProvier
					.getChildren(((ConcretemodelDomainNavigatorItem) parentElement).getEObject()), parentElement);
		}
		return EMPTY_ARRAY;
	}
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new ConcretemodelDomainNavigatorItem((EObject) objects[i], parentElement,

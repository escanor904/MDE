...
/**
 * This is the item provider adapter for a {@link dslrelational.Parameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DslrelationalPackage.Literals.PARAMETER__NAME,
				 true,
				 false,
				 false,
	...
	protected void addColumnTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Parameter_columnType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Parameter_columnType_feature", "_UI_Parameter_type"),
				 DslrelationalPackage.Literals.PARAMETER__COLUMN_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,

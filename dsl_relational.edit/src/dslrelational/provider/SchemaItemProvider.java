...
/**
 * This is the item provider adapter for a {@link dslrelational.Schema} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SchemaItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DslrelationalPackage.Literals.SCHEMA__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DslrelationalPackage.Literals.SCHEMA__LST_TABLE);
			childrenFeatures.add(DslrelationalPackage.Literals.SCHEMA__LST_FUNCTION);
			childrenFeatures.add(DslrelationalPackage.Literals.SCHEMA__LST_TRIGGER);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DslrelationalPackage.Literals.SCHEMA__LST_TABLE,
				 DslrelationalFactory.eINSTANCE.createTable()));

		newChildDescriptors.add
			(createChildParameter
				(DslrelationalPackage.Literals.SCHEMA__LST_FUNCTION,
				 DslrelationalFactory.eINSTANCE.createFunction()));

		newChildDescriptors.add
			(createChildParameter
				(DslrelationalPackage.Literals.SCHEMA__LST_TRIGGER,

...
/**
 * This is the item provider adapter for a {@link dslrelational.Table} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DslrelationalPackage.Literals.TABLE__NAME,
				 true,
				 false,
				 false,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DslrelationalPackage.Literals.TABLE__LST_COLUMN,
				 DslrelationalFactory.eINSTANCE.createColumn()));

		newChildDescriptors.add
			(createChildParameter
				(DslrelationalPackage.Literals.TABLE__LST_PRIMARY_KEY,
				 DslrelationalFactory.eINSTANCE.createPrimaryKey()));

		newChildDescriptors.add
			(createChildParameter
				(DslrelationalPackage.Literals.TABLE__LST_FOREIGN_KEY,

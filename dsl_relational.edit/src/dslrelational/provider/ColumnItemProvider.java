...
public class ColumnItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DslrelationalPackage.Literals.COLUMN__OWNED_BY_TABLE);
			childrenFeatures.add(DslrelationalPackage.Literals.COLUMN__LST_PRIMARY_KEY);
		}
		...
		newChildDescriptors.add
			(createChildParameter
				(DslrelationalPackage.Literals.COLUMN__LST_PRIMARY_KEY,
				 DslrelationalFactory.eINSTANCE.createPrimaryKey()));
	}

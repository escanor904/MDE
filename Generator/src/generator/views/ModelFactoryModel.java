...
//				"	ModelFactoryAbstract modelFactoryAbstracta = AbstractaFactory.eINSTANCE.createModelFactoryAbstract();\r\n" + 
//				"\r\n" + 
//				"	public ModelFactoryModel() {\r\n" + 
...
//				"		\r\n" + 
//				"		\r\n" + 
//				"		for (concreta.ProjectRam projectRamConcreta : modelFactoryConcreta.getListProjects()) {\r\n" + 
//				"\r\n" + 
//				"			// por un proyecto de la concrera se crea uno en la abstracta\r\n" + 
//				"			ProjectRam proyectoRamAbstracta = AbstractaFactory.eINSTANCE.createProjectRam();\r\n" + 
...
//				"			\r\n" + 
//				"			abstracta.PackageRam packageRaizRam = AbstractaFactory.eINSTANCE.createPackageRam();\r\n" + 
...
//				"			\r\n" + 
//				"			for (DiagramClassRam diagrama : projectRamConcreta.getListDiagramClassRam()) {\r\n" + 
...
//				"\r\n" + 
//				"\r\n" + 
//				"	private void crearPaquete(PackageRam packageConcreta, abstracta.PackageRam packageRaizRam) {\r\n" + 
//				"\r\n" + 
...
//				"		newPaqueteAbstracta.setPath(packageConcreta.getPath()== null?\"\":packageConcreta.getPath());\r\n" + 
//				"\r\n" + 
//				"		abstracta.PackageRam packageRamPadre = obtenerPackagePadre(packageConcreta.getPath(),packageRaizRam);//src/main\r\n" + 
...
//				"\r\n" + 
//				"\r\n" + 
//				"	private abstracta.PackageRam obtenerPackagePadre(String path, abstracta.PackageRam packageRaizRam) {\r\n" + 
//				"		\r\n" + 
//				"		\r\n" + 
...
//				"\r\n" + 
//				"\r\n" + 
//				"	private abstracta.PackageRam obtenerPaquete(String nameP,abstracta.PackageRam packageParentRam) {\r\n" + 
//				"		for (abstracta.PackageRam pac : packageParentRam.getListPackagesChildsRam()) {\r\n" + 
//				"			if(pac.getName().equalsIgnoreCase(nameP)) {\r\n" + 
//				"				return pac;\r\n" + 
//				"			}\r\n" + 
//				"		}\r\n" + 
//				"		abstracta.PackageRam packageRam2 = AbstractaFactory.eINSTANCE.createPackageRam();\r\n" + 
...
//				"		cadenaClass.append(\"\");\r\n" + 
//				"\r\n" + 
//				"		createFileWindows(clase.getPathPackage(), clase.getName()+\".java\", cadenaClass.toString());\r\n" + 
//				"	}\r\n" + 
//				"\r\n" + 
//				"\r\n" + 
//				"\r\n" + 

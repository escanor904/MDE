...
public class PropertiesAdjRadioButton extends Dialog {
	 ...
	 * @param model 
	 */
	public PropertiesAdjRadioButton(Shell parentShell, uidiagram.AdjRadioButton model, TransactionalEditingDomain domain, EditPart editpart) {
		super(parentShell);
		this.model = model;
		this.domain = domain;
	...
	protected Control createDialogArea(Composite parent) {
		...
		lblDeta.setText("Properties AdjRadioButton");
	 ...
	 */
	 public class ChangeOPerationDialogCommand extends RecordingCommand{
	        ...
	        private uidiagram.AdjRadioButton modelElementWidget; 
	        String evento = new String();
	        TransactionalEditingDomain transactionalEditingDomain2;
	        public ChangeOPerationDialogCommand(TransactionalEditingDomain transactionalEditingDomain,uidiagram.AdjRadioButton modelElementWidget,String event) {

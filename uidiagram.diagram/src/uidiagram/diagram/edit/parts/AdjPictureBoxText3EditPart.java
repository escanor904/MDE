 ...
 * @generated
 */
public class AdjPictureBoxText3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AdjPictureBoxText3EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = UidiagramParserProvider.getParser(UidiagramElementTypes.AdjPictureBox_3108, getParserElement(),
					UidiagramVisualIDRegistry
							.getType(uidiagram.diagram.edit.parts.AdjPictureBoxText3EditPart.VISUAL_ID));
		}
		return parser;
	}

...
public class PropertiesAdjLabel extends Dialog {
	 ...
	 * @param model 
	 */
	public PropertiesAdjLabel(Shell parentShell, uidiagram.AdjLabel model, TransactionalEditingDomain domain, EditPart editpart) {
		super(parentShell);
		this.model = model;
		this.domain = domain;

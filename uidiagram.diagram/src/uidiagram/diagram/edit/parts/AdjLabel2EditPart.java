...
import uidiagram.diagram.edit.policies.AdjLabel2ItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class AdjLabel2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public AdjLabel2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new AdjLabel2ItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new AdjLabelFigure();
	}

	/**
	* @generated
	*/
	public AdjLabelFigure getPrimaryShape() {
		return (AdjLabelFigure) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AdjLabelText2EditPart) {
			((AdjLabelText2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureAdjLabelLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(AdjLabelText2EditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class AdjLabelFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureAdjLabelLabelFigure;

		/**
		 * @generated
		 */
		public AdjLabelFigure() {
		...
		private void createContents() {
			...
			fFigureAdjLabelLabelFigure = new WrappingLabel();

			fFigureAdjLabelLabelFigure.setText("AdjLabel");

			this.add(fFigureAdjLabelLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureAdjLabelLabelFigure() {

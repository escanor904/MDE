...
import uidiagram.diagram.edit.policies.AdjListBoxItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class AdjListBoxEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public AdjListBoxEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new AdjListBoxItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AdjListBoxTextEditPart) {
			((AdjListBoxTextEditPart) childEditPart).setLabel(getPrimaryShape().getFigureAdjListBoxLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(AdjListBoxTextEditPart.VISUAL_ID));
	}

...
public class PropertiesAdjTextBox extends Dialog {
	 ...
	 * @param model 
	 */
	public PropertiesAdjTextBox(Shell parentShell, uidiagram.AdjTextBox model, TransactionalEditingDomain domain, EditPart editpart) {
		super(parentShell);
		this.model = model;
		this.domain = domain;
	...
	protected Control createDialogArea(Composite parent) {
		...
		lblDeta.setText("Properties AdjTextBox");
	 ...
	 */
	 public class ChangeOPerationDialogCommand extends RecordingCommand{
	        ...
	        private uidiagram.AdjTextBox modelElementWidget; 
	        String evento = new String();
	        TransactionalEditingDomain transactionalEditingDomain2;
	        public ChangeOPerationDialogCommand(TransactionalEditingDomain transactionalEditingDomain,uidiagram.AdjTextBox modelElementWidget,String event) {

...
import uidiagram.diagram.edit.policies.AdjDateTimePicker2ItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class AdjDateTimePicker2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public AdjDateTimePicker2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new AdjDateTimePicker2ItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new AdjDateTimePickerFigure();
	}

	/**
	* @generated
	*/
	public AdjDateTimePickerFigure getPrimaryShape() {
		return (AdjDateTimePickerFigure) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AdjDateTimePickerText2EditPart) {
			((AdjDateTimePickerText2EditPart) childEditPart)
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(AdjDateTimePickerText2EditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class AdjDateTimePickerFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureAdjDateTimePickerLabelFigure;

		/**
		 * @generated
		 */
		public AdjDateTimePickerFigure() {
		...
		private void createContents() {
			...
			fFigureAdjDateTimePickerLabelFigure = new WrappingLabel();

			fFigureAdjDateTimePickerLabelFigure.setText("AdjDateTimePicker");

			this.add(fFigureAdjDateTimePickerLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureAdjDateTimePickerLabelFigure() {
			return fFigureAdjDateTimePickerLabelFigure;
		}

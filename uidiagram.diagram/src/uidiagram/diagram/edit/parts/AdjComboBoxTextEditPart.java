 ...
 * @generated
 */
public class AdjComboBoxTextEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AdjComboBoxTextEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UidiagramParserProvider.getParser(UidiagramElementTypes.AdjComboBox_3087, getParserElement(),
					UidiagramVisualIDRegistry.getType(uidiagram.diagram.edit.parts.AdjComboBoxTextEditPart.VISUAL_ID));
		}
		return parser;
	}

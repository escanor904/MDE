...
import uidiagram.diagram.edit.policies.AdjPictureBox2ItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class AdjPictureBox2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public AdjPictureBox2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new AdjPictureBox2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AdjPictureBoxText2EditPart) {
			((AdjPictureBoxText2EditPart) childEditPart)
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(AdjPictureBoxText2EditPart.VISUAL_ID));
	}

...
import uidiagram.diagram.edit.policies.AdjCheckBoxItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class AdjCheckBoxEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public AdjCheckBoxEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new AdjCheckBoxItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AdjCheckBoxTextEditPart) {
			((AdjCheckBoxTextEditPart) childEditPart).setLabel(getPrimaryShape().getFigureAdjCheckBoxLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(AdjCheckBoxTextEditPart.VISUAL_ID));
	}

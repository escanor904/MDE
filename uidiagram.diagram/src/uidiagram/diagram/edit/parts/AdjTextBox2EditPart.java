...
import uidiagram.diagram.edit.policies.AdjTextBox2ItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class AdjTextBox2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public AdjTextBox2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new AdjTextBox2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AdjTextBoxText2EditPart) {
			((AdjTextBoxText2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureAdjTextBoxLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(AdjTextBoxText2EditPart.VISUAL_ID));
	}

 ...
 * @generated
 */
public class AdjGroupBoxName5EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AdjGroupBoxName5EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UidiagramParserProvider.getParser(UidiagramElementTypes.AdjGroupBox_3084, getParserElement(),
					UidiagramVisualIDRegistry.getType(uidiagram.diagram.edit.parts.AdjGroupBoxName5EditPart.VISUAL_ID));
		}
		return parser;
	}

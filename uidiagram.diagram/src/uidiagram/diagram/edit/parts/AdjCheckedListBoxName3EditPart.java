 ...
 * @generated
 */
public class AdjCheckedListBoxName3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AdjCheckedListBoxName3EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = UidiagramParserProvider.getParser(UidiagramElementTypes.AdjCheckedListBox_3037, getParserElement(),
					UidiagramVisualIDRegistry
							.getType(uidiagram.diagram.edit.parts.AdjCheckedListBoxName3EditPart.VISUAL_ID));
		}
		return parser;
	}

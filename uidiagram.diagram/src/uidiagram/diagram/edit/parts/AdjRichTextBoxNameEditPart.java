 ...
 * @generated
 */
public class AdjRichTextBoxNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AdjRichTextBoxNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UidiagramParserProvider.getParser(UidiagramElementTypes.AdjRichTextBox_3009, getParserElement(),
					UidiagramVisualIDRegistry
							.getType(uidiagram.diagram.edit.parts.AdjRichTextBoxNameEditPart.VISUAL_ID));
		}
		return parser;
	}

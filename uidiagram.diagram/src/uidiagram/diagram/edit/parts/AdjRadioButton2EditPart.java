...
import uidiagram.diagram.edit.policies.AdjRadioButton2ItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class AdjRadioButton2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public AdjRadioButton2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new AdjRadioButton2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AdjRadioButtonText2EditPart) {
			((AdjRadioButtonText2EditPart) childEditPart)
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(AdjRadioButtonText2EditPart.VISUAL_ID));
	}

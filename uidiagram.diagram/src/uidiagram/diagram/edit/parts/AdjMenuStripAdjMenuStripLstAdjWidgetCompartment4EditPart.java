...
import uidiagram.diagram.edit.policies.AdjMenuStripAdjMenuStripLstAdjWidgetCompartment4CanonicalEditPolicy;
import uidiagram.diagram.edit.policies.AdjMenuStripAdjMenuStripLstAdjWidgetCompartment4ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class AdjMenuStripAdjMenuStripLstAdjWidgetCompartment4EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public AdjMenuStripAdjMenuStripLstAdjWidgetCompartment4EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.AdjMenuStripAdjMenuStripLstAdjWidgetCompartment4EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new AdjMenuStripAdjMenuStripLstAdjWidgetCompartment4ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new AdjMenuStripAdjMenuStripLstAdjWidgetCompartment4CanonicalEditPolicy());
	}

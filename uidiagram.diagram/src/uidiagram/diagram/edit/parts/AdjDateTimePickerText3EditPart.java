 ...
 * @generated
 */
public class AdjDateTimePickerText3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AdjDateTimePickerText3EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = UidiagramParserProvider.getParser(UidiagramElementTypes.AdjDateTimePicker_3104, getParserElement(),
					UidiagramVisualIDRegistry
							.getType(uidiagram.diagram.edit.parts.AdjDateTimePickerText3EditPart.VISUAL_ID));
		}
		return parser;
	}

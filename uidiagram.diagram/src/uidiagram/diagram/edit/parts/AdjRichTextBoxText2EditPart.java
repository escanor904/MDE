 ...
 * @generated
 */
public class AdjRichTextBoxText2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AdjRichTextBoxText2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UidiagramParserProvider.getParser(UidiagramElementTypes.AdjRichTextBox_3024, getParserElement(),
					UidiagramVisualIDRegistry
							.getType(uidiagram.diagram.edit.parts.AdjRichTextBoxText2EditPart.VISUAL_ID));
		}
		return parser;
	}

 ...
 * @generated
 */
public class AdjListViewColumnTextEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AdjListViewColumnTextEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = UidiagramParserProvider.getParser(UidiagramElementTypes.AdjListViewColumn_3093, getParserElement(),
					UidiagramVisualIDRegistry
							.getType(uidiagram.diagram.edit.parts.AdjListViewColumnTextEditPart.VISUAL_ID));
		}
		return parser;
	}

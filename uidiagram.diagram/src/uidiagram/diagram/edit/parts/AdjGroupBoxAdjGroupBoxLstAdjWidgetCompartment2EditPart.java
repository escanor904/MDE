...
import uidiagram.diagram.edit.policies.AdjGroupBoxAdjGroupBoxLstAdjWidgetCompartment2CanonicalEditPolicy;
import uidiagram.diagram.edit.policies.AdjGroupBoxAdjGroupBoxLstAdjWidgetCompartment2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class AdjGroupBoxAdjGroupBoxLstAdjWidgetCompartment2EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public AdjGroupBoxAdjGroupBoxLstAdjWidgetCompartment2EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.AdjGroupBoxAdjGroupBoxLstAdjWidgetCompartment2EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new AdjGroupBoxAdjGroupBoxLstAdjWidgetCompartment2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new AdjGroupBoxAdjGroupBoxLstAdjWidgetCompartment2CanonicalEditPolicy());
	}

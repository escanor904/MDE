...
import uidiagram.diagram.edit.policies.AdjButton5ItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class AdjButton5EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public AdjButton5EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new AdjButton5ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AdjButtonName5EditPart) {
			((AdjButtonName5EditPart) childEditPart).setLabel(getPrimaryShape().getFigureAdjButtonLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(AdjButtonName5EditPart.VISUAL_ID));
	}

...
import uidiagram.diagram.edit.policies.AdjToolStripAdjToolStripLstAdjWidgetCompartment3CanonicalEditPolicy;
import uidiagram.diagram.edit.policies.AdjToolStripAdjToolStripLstAdjWidgetCompartment3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class AdjToolStripAdjToolStripLstAdjWidgetCompartment3EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public AdjToolStripAdjToolStripLstAdjWidgetCompartment3EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.AdjToolStripAdjToolStripLstAdjWidgetCompartment3EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new AdjToolStripAdjToolStripLstAdjWidgetCompartment3ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new AdjToolStripAdjToolStripLstAdjWidgetCompartment3CanonicalEditPolicy());
	}

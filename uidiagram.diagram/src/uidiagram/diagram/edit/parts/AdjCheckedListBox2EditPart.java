...
import uidiagram.diagram.edit.policies.AdjCheckedListBox2ItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class AdjCheckedListBox2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public AdjCheckedListBox2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new AdjCheckedListBox2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AdjCheckedListBoxText2EditPart) {
			((AdjCheckedListBoxText2EditPart) childEditPart)
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(AdjCheckedListBoxText2EditPart.VISUAL_ID));
	}

...
import uidiagram.diagram.edit.policies.AdjRadioButton3ItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class AdjRadioButton3EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public AdjRadioButton3EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new AdjRadioButton3ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AdjRadioButtonText3EditPart) {
			((AdjRadioButtonText3EditPart) childEditPart)
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(AdjRadioButtonText3EditPart.VISUAL_ID));
	}

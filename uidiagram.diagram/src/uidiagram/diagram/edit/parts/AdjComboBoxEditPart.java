...
import uidiagram.diagram.edit.policies.AdjComboBoxItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class AdjComboBoxEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public AdjComboBoxEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new AdjComboBoxItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AdjComboBoxTextEditPart) {
			((AdjComboBoxTextEditPart) childEditPart).setLabel(getPrimaryShape().getFigureAdjComboBoxLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(AdjComboBoxTextEditPart.VISUAL_ID));
	}

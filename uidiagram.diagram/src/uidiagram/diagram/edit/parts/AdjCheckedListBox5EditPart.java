...
import uidiagram.diagram.edit.policies.AdjCheckedListBox5ItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class AdjCheckedListBox5EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public AdjCheckedListBox5EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new AdjCheckedListBox5ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AdjCheckedListBoxName5EditPart) {
			((AdjCheckedListBoxName5EditPart) childEditPart)
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(AdjCheckedListBoxName5EditPart.VISUAL_ID));
	}

...
import uidiagram.diagram.edit.policies.AdjListViewItemSemanticEditPolicy;
 ...
 * @generated
 */
public class AdjListViewEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public AdjListViewEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new AdjListViewItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AdjListViewTextEditPart) {
			((AdjListViewTextEditPart) childEditPart).setLabel(getPrimaryShape().getFigureAdjListViewLabelFigure());
			return true;
		}
		if (childEditPart instanceof AdjListViewAdjListViewLstAdjListViewColumnCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getAdjListViewLstAdjListViewColumnCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((AdjListViewAdjListViewLstAdjListViewColumnCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof AdjListViewAdjListViewLstAdjListViewColumnCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getAdjListViewLstAdjListViewColumnCompartmentFigure();
			pane.remove(((AdjListViewAdjListViewLstAdjListViewColumnCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof AdjListViewAdjListViewLstAdjListViewColumnCompartmentEditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(AdjListViewTextEditPart.VISUAL_ID));
	}

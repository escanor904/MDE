 ...
 * @generated
 */
public class AdjLinkLabelName3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AdjLinkLabelName3EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = UidiagramParserProvider.getParser(UidiagramElementTypes.AdjLinkLabel_3038, getParserElement(),
					UidiagramVisualIDRegistry
							.getType(uidiagram.diagram.edit.parts.AdjLinkLabelName3EditPart.VISUAL_ID));
		}
		return parser;
	}

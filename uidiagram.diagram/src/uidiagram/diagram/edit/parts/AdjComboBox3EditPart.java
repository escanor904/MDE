...
import uidiagram.diagram.edit.policies.AdjComboBox3ItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class AdjComboBox3EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public AdjComboBox3EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new AdjComboBox3ItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new AdjComboBoxFigure();
	}

	/**
	* @generated
	*/
	public AdjComboBoxFigure getPrimaryShape() {
		return (AdjComboBoxFigure) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AdjComboBoxText3EditPart) {
			((AdjComboBoxText3EditPart) childEditPart).setLabel(getPrimaryShape().getFigureAdjComboBoxLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(AdjComboBoxText3EditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class AdjComboBoxFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureAdjComboBoxLabelFigure;

		/**
		 * @generated
		 */
		public AdjComboBoxFigure() {
		...
		private void createContents() {
			...
			fFigureAdjComboBoxLabelFigure = new WrappingLabel();

			fFigureAdjComboBoxLabelFigure.setText("AdjComboBox");

			this.add(fFigureAdjComboBoxLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureAdjComboBoxLabelFigure() {
			return fFigureAdjComboBoxLabelFigure;
		}

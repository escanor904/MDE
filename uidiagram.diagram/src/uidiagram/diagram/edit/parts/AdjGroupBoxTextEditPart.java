 ...
 * @generated
 */
public class AdjGroupBoxTextEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AdjGroupBoxTextEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UidiagramParserProvider.getParser(UidiagramElementTypes.AdjGroupBox_3030, getParserElement(),
					UidiagramVisualIDRegistry.getType(uidiagram.diagram.edit.parts.AdjGroupBoxTextEditPart.VISUAL_ID));
		}
		return parser;
	}

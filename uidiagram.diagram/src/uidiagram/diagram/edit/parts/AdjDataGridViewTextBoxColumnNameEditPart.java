 ...
 * @generated
 */
public class AdjDataGridViewTextBoxColumnNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AdjDataGridViewTextBoxColumnNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UidiagramParserProvider.getParser(UidiagramElementTypes.AdjDataGridViewTextBoxColumn_3014,
					getParserElement(), UidiagramVisualIDRegistry
							.getType(uidiagram.diagram.edit.parts.AdjDataGridViewTextBoxColumnNameEditPart.VISUAL_ID));
		}
		return parser;
	}

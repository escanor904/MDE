...
import uidiagram.diagram.edit.policies.AdjLinkLabel2ItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class AdjLinkLabel2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public AdjLinkLabel2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new AdjLinkLabel2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AdjLinkLabelText2EditPart) {
			((AdjLinkLabelText2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureAdjLinkLabelLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(AdjLinkLabelText2EditPart.VISUAL_ID));
	}

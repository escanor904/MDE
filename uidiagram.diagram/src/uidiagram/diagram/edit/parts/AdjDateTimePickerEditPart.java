...
import uidiagram.diagram.edit.policies.AdjDateTimePickerItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class AdjDateTimePickerEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public AdjDateTimePickerEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new AdjDateTimePickerItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AdjDateTimePickerTextEditPart) {
			((AdjDateTimePickerTextEditPart) childEditPart)
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(AdjDateTimePickerTextEditPart.VISUAL_ID));
	}

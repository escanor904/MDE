...
import uidiagram.diagram.edit.policies.AdjTextBoxItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class AdjTextBoxEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public AdjTextBoxEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new AdjTextBoxItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AdjTextBoxTextEditPart) {
			((AdjTextBoxTextEditPart) childEditPart).setLabel(getPrimaryShape().getFigureAdjTextBoxLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(AdjTextBoxTextEditPart.VISUAL_ID));
	}

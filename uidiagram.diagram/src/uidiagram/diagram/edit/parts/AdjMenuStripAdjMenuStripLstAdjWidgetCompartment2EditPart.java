...
import uidiagram.diagram.edit.policies.AdjMenuStripAdjMenuStripLstAdjWidgetCompartment2CanonicalEditPolicy;
import uidiagram.diagram.edit.policies.AdjMenuStripAdjMenuStripLstAdjWidgetCompartment2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class AdjMenuStripAdjMenuStripLstAdjWidgetCompartment2EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public AdjMenuStripAdjMenuStripLstAdjWidgetCompartment2EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.AdjMenuStripAdjMenuStripLstAdjWidgetCompartment2EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new AdjMenuStripAdjMenuStripLstAdjWidgetCompartment2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new AdjMenuStripAdjMenuStripLstAdjWidgetCompartment2CanonicalEditPolicy());
	}

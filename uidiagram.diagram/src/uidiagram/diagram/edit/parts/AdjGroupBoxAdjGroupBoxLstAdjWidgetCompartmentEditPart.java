...
import uidiagram.diagram.edit.policies.AdjGroupBoxAdjGroupBoxLstAdjWidgetCompartmentCanonicalEditPolicy;
import uidiagram.diagram.edit.policies.AdjGroupBoxAdjGroupBoxLstAdjWidgetCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class AdjGroupBoxAdjGroupBoxLstAdjWidgetCompartmentEditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public AdjGroupBoxAdjGroupBoxLstAdjWidgetCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.AdjGroupBoxAdjGroupBoxLstAdjWidgetCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new AdjGroupBoxAdjGroupBoxLstAdjWidgetCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new AdjGroupBoxAdjGroupBoxLstAdjWidgetCompartmentCanonicalEditPolicy());
	}

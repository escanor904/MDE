...
public class PropertiesAdjDateTimePicker extends Dialog {
	...
	private AdjDateTimePicker model;
	 ...
	 * @param model 
	 */
	public PropertiesAdjDateTimePicker(Shell parentShell, uidiagram.AdjDateTimePicker model, TransactionalEditingDomain domain, EditPart editpart) {
		super(parentShell);
		this.model = model;
		this.domain = domain;
	...
	protected Control createDialogArea(Composite parent) {
		...
		lblDeta.setText("Properties AdjDateTimePicker");
	 ...
	 */
	 public class ChangeOPerationDialogCommand extends RecordingCommand{
	        ...
	        private uidiagram.AdjDateTimePicker modelElementWidget; 
	        String evento = new String();
	        TransactionalEditingDomain transactionalEditingDomain2;
	        public ChangeOPerationDialogCommand(TransactionalEditingDomain transactionalEditingDomain,uidiagram.AdjDateTimePicker modelElementWidget,String event) {

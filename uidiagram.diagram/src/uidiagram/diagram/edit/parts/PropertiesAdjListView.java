...
public class PropertiesAdjListView extends Dialog {
	 ...
	 * @param model 
	 */
	public PropertiesAdjListView(Shell parentShell, uidiagram.AdjListView model, TransactionalEditingDomain domain, EditPart editpart) {
		super(parentShell);
		this.model = model;
		this.domain = domain;
	 ...
	 */
	 public class ChangeOPerationDialogCommand extends RecordingCommand{
	        ...
	        private uidiagram.AdjListView modelElementWidget; 
	        String evento = new String();
	        TransactionalEditingDomain transactionalEditingDomain2;
	        public ChangeOPerationDialogCommand(TransactionalEditingDomain transactionalEditingDomain,uidiagram.AdjListView modelElementWidget,String event) {

 ...
 * @generated
 */
public class AdjPictureBoxText2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AdjPictureBoxText2EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = UidiagramParserProvider.getParser(UidiagramElementTypes.AdjPictureBox_3107, getParserElement(),
					UidiagramVisualIDRegistry
							.getType(uidiagram.diagram.edit.parts.AdjPictureBoxText2EditPart.VISUAL_ID));
		}
		return parser;
	}

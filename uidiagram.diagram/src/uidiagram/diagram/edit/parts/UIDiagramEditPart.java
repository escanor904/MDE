...
import uidiagram.diagram.edit.policies.UIDiagramCanonicalEditPolicy;
import uidiagram.diagram.edit.policies.UIDiagramItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class UIDiagramEditPart extends DiagramEditPart {
	...
	* @generated
	*/
	public UIDiagramEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new UIDiagramItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new UIDiagramCanonicalEditPolicy());

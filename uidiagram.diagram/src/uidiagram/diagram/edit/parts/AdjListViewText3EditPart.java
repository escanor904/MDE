 ...
 * @generated
 */
public class AdjListViewText3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AdjListViewText3EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UidiagramParserProvider.getParser(UidiagramElementTypes.AdjListView_3095, getParserElement(),
					UidiagramVisualIDRegistry.getType(uidiagram.diagram.edit.parts.AdjListViewText3EditPart.VISUAL_ID));
		}
		return parser;
	}

...
import uidiagram.diagram.edit.policies.AdjGroupBoxItemSemanticEditPolicy;
 ...
 * @generated
 */
public class AdjGroupBoxEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public AdjGroupBoxEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new AdjGroupBoxItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof AdjGroupBoxAdjGroupBoxLstAdjWidgetCompartmentEditPart) {
			...
			pane.add(((AdjGroupBoxAdjGroupBoxLstAdjWidgetCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof AdjGroupBoxAdjGroupBoxLstAdjWidgetCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getAdjGroupBoxLstAdjWidgetCompartmentFigure();
			pane.remove(((AdjGroupBoxAdjGroupBoxLstAdjWidgetCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof AdjGroupBoxAdjGroupBoxLstAdjWidgetCompartmentEditPart) {

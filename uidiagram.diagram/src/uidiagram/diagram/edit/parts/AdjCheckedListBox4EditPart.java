...
import uidiagram.diagram.edit.policies.AdjCheckedListBox4ItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class AdjCheckedListBox4EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public AdjCheckedListBox4EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new AdjCheckedListBox4ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AdjCheckedListBoxName4EditPart) {
			((AdjCheckedListBoxName4EditPart) childEditPart)
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(AdjCheckedListBoxName4EditPart.VISUAL_ID));
	}

...
public class PropertiesAdjCheckedListBox extends Dialog {
	...
	private AdjCheckedListBox model;
	 ...
	 * @param model 
	 */
	public PropertiesAdjCheckedListBox(Shell parentShell, uidiagram.AdjCheckedListBox model, TransactionalEditingDomain domain, EditPart editpart) {
		super(parentShell);
		this.model = model;
		this.domain = domain;
	...
	protected Control createDialogArea(Composite parent) {
		...
		lblDeta.setText("Properties AdjCheckedListBox");
	 ...
	 */
	 public class ChangeOPerationDialogCommand extends RecordingCommand{
	        ...
	        private uidiagram.AdjCheckedListBox modelElementWidget; 
	        String evento = new String();
	        TransactionalEditingDomain transactionalEditingDomain2;
	        public ChangeOPerationDialogCommand(TransactionalEditingDomain transactionalEditingDomain,uidiagram.AdjCheckedListBox modelElementWidget,String event) {

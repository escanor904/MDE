 ...
 * @generated
 */
public class AdjCheckedListBoxName4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AdjCheckedListBoxName4EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UidiagramParserProvider.getParser(UidiagramElementTypes.AdjCheckedListBox_3052, getParserElement(),
					UidiagramVisualIDRegistry
							.getType(uidiagram.diagram.edit.parts.AdjCheckedListBoxName4EditPart.VISUAL_ID));
		}
		return parser;
	}

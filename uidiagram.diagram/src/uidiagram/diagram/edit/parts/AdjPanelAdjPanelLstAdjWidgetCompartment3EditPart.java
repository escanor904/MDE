...
import uidiagram.diagram.edit.policies.AdjPanelAdjPanelLstAdjWidgetCompartment3CanonicalEditPolicy;
import uidiagram.diagram.edit.policies.AdjPanelAdjPanelLstAdjWidgetCompartment3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class AdjPanelAdjPanelLstAdjWidgetCompartment3EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public AdjPanelAdjPanelLstAdjWidgetCompartment3EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.AdjPanelAdjPanelLstAdjWidgetCompartment3EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new AdjPanelAdjPanelLstAdjWidgetCompartment3ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new AdjPanelAdjPanelLstAdjWidgetCompartment3CanonicalEditPolicy());
	}

...
import uidiagram.diagram.edit.policies.AdjPanelAdjPanelLstAdjWidgetCompartment5CanonicalEditPolicy;
import uidiagram.diagram.edit.policies.AdjPanelAdjPanelLstAdjWidgetCompartment5ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class AdjPanelAdjPanelLstAdjWidgetCompartment5EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public AdjPanelAdjPanelLstAdjWidgetCompartment5EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.AdjPanelAdjPanelLstAdjWidgetCompartment5EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new AdjPanelAdjPanelLstAdjWidgetCompartment5ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new AdjPanelAdjPanelLstAdjWidgetCompartment5CanonicalEditPolicy());
	}

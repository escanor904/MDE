 ...
 * @generated
 */
public class AdjCheckedListBoxTextEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AdjCheckedListBoxTextEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = UidiagramParserProvider.getParser(UidiagramElementTypes.AdjCheckedListBox_3007, getParserElement(),
					UidiagramVisualIDRegistry
							.getType(uidiagram.diagram.edit.parts.AdjCheckedListBoxTextEditPart.VISUAL_ID));
		}
		return parser;
	}

...
public class PropertiesAdjListBox extends Dialog {
	 ...
	 * @param model 
	 */
	public PropertiesAdjListBox(Shell parentShell, uidiagram.AdjListBox model, TransactionalEditingDomain domain, EditPart editpart) {
		super(parentShell);
		this.model = model;
		this.domain = domain;
	...
	protected Control createDialogArea(Composite parent) {
		...
		lblDeta.setText("Properties AdjListBox");
	 ...
	 */
	 public class ChangeOPerationDialogCommand extends RecordingCommand{
	        ...
	        private uidiagram.AdjListBox modelElementWidget; 
	        String evento = new String();
	        TransactionalEditingDomain transactionalEditingDomain2;
	        public ChangeOPerationDialogCommand(TransactionalEditingDomain transactionalEditingDomain,uidiagram.AdjListBox modelElementWidget,String event) {

...
public class PropertiesFormUI extends Dialog {
	 ...
	 * @param model 
	 */
	public PropertiesFormUI(Shell parentShell, uidiagram.AdjLabel model, TransactionalEditingDomain domain, EditPart editpart) {
		super(parentShell);
		this.model = model;
		this.domain = domain;
	...
	protected Control createDialogArea(Composite parent) {
		...
		lblDeta.setText("Properties FormUI");

 ...
 * @generated
 */
public class AdjCheckedListBoxText3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AdjCheckedListBoxText3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UidiagramParserProvider.getParser(UidiagramElementTypes.AdjCheckedListBox_3037, getParserElement(),
					UidiagramVisualIDRegistry
							.getType(uidiagram.diagram.edit.parts.AdjCheckedListBoxText3EditPart.VISUAL_ID));
		}
		return parser;
	}

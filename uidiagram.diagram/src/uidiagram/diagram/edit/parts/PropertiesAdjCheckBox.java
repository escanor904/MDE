...
public class PropertiesAdjCheckBox extends Dialog {
	 ...
	 * @param model 
	 */
	public PropertiesAdjCheckBox(Shell parentShell, uidiagram.AdjCheckBox model, TransactionalEditingDomain domain, EditPart editpart) {
		super(parentShell);
		this.model = model;
		this.domain = domain;
	...
	protected Control createDialogArea(Composite parent) {
		...
		lblDeta.setText("Properties AdjCheckBox");
	 ...
	 */
	 public class ChangeOPerationDialogCommand extends RecordingCommand{
	        ...
	        private uidiagram.AdjCheckBox modelElementWidget; 
	        String evento = new String();
	        TransactionalEditingDomain transactionalEditingDomain2;
	        public ChangeOPerationDialogCommand(TransactionalEditingDomain transactionalEditingDomain,uidiagram.AdjCheckBox modelElementWidget,String event) {

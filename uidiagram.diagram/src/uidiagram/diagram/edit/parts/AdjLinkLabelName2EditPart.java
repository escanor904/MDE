 ...
 * @generated
 */
public class AdjLinkLabelName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AdjLinkLabelName2EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = UidiagramParserProvider.getParser(UidiagramElementTypes.AdjLinkLabel_3023, getParserElement(),
					UidiagramVisualIDRegistry
							.getType(uidiagram.diagram.edit.parts.AdjLinkLabelName2EditPart.VISUAL_ID));
		}
		return parser;
	}

 ...
 * @generated
 */
public class AdjRadioButtonName3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AdjRadioButtonName3EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = UidiagramParserProvider.getParser(UidiagramElementTypes.AdjRadioButton_3105, getParserElement(),
					UidiagramVisualIDRegistry
							.getType(uidiagram.diagram.edit.parts.AdjRadioButtonName3EditPart.VISUAL_ID));
		}
		return parser;
	}

...
import uidiagram.diagram.edit.policies.AdjRichTextBox3ItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class AdjRichTextBox3EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public AdjRichTextBox3EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new AdjRichTextBox3ItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new AdjRichTextBoxFigure();
	}

	/**
	* @generated
	*/
	public AdjRichTextBoxFigure getPrimaryShape() {
		return (AdjRichTextBoxFigure) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AdjRichTextBoxText3EditPart) {
			((AdjRichTextBoxText3EditPart) childEditPart)
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(AdjRichTextBoxText3EditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class AdjRichTextBoxFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureAdjRichTextBoxLabelFigure;

		/**
		 * @generated
		 */
		public AdjRichTextBoxFigure() {
		...
		private void createContents() {
			...
			fFigureAdjRichTextBoxLabelFigure = new WrappingLabel();

			fFigureAdjRichTextBoxLabelFigure.setText("AdjRichTextBox");

			this.add(fFigureAdjRichTextBoxLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureAdjRichTextBoxLabelFigure() {
			return fFigureAdjRichTextBoxLabelFigure;
		}

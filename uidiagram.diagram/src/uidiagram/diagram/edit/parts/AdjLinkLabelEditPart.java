...
import uidiagram.diagram.edit.policies.AdjLinkLabelItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class AdjLinkLabelEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public AdjLinkLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new AdjLinkLabelItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AdjLinkLabelTextEditPart) {
			((AdjLinkLabelTextEditPart) childEditPart).setLabel(getPrimaryShape().getFigureAdjLinkLabelLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(AdjLinkLabelTextEditPart.VISUAL_ID));
	}

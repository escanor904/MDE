...
import uidiagram.diagram.edit.policies.AdjButton2ItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class AdjButton2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public AdjButton2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new AdjButton2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AdjButtonText2EditPart) {
			((AdjButtonText2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureAdjButtonLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(AdjButtonText2EditPart.VISUAL_ID));
	}

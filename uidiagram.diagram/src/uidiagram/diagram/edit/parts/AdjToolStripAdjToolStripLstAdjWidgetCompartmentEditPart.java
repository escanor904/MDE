...
import uidiagram.diagram.edit.policies.AdjToolStripAdjToolStripLstAdjWidgetCompartmentCanonicalEditPolicy;
import uidiagram.diagram.edit.policies.AdjToolStripAdjToolStripLstAdjWidgetCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class AdjToolStripAdjToolStripLstAdjWidgetCompartmentEditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public AdjToolStripAdjToolStripLstAdjWidgetCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.AdjToolStripAdjToolStripLstAdjWidgetCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new AdjToolStripAdjToolStripLstAdjWidgetCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new AdjToolStripAdjToolStripLstAdjWidgetCompartmentCanonicalEditPolicy());
	}

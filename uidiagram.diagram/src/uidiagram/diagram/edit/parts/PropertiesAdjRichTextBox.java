...
public class PropertiesAdjRichTextBox extends Dialog {
	 ...
	 * @param model 
	 */
	public PropertiesAdjRichTextBox(Shell parentShell, uidiagram.AdjRichTextBox model, TransactionalEditingDomain domain, EditPart editpart) {
		super(parentShell);
		this.model = model;
		this.domain = domain;
	...
	protected Control createDialogArea(Composite parent) {
		...
		lblDeta.setText("Properties AdjRichTextBox");
	 ...
	 */
	 public class ChangeOPerationDialogCommand extends RecordingCommand{
	        ...
	        private uidiagram.AdjRichTextBox modelElementWidget; 
	        String evento = new String();
	        TransactionalEditingDomain transactionalEditingDomain2;
	        public ChangeOPerationDialogCommand(TransactionalEditingDomain transactionalEditingDomain,uidiagram.AdjRichTextBox modelElementWidget,String event) {

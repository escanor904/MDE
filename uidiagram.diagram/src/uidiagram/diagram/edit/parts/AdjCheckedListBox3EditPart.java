...
import uidiagram.diagram.edit.policies.AdjCheckedListBox3ItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class AdjCheckedListBox3EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public AdjCheckedListBox3EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new AdjCheckedListBox3ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AdjCheckedListBoxText3EditPart) {
			((AdjCheckedListBoxText3EditPart) childEditPart)
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(AdjCheckedListBoxText3EditPart.VISUAL_ID));
	}

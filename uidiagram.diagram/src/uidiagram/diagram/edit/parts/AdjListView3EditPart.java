...
import uidiagram.diagram.edit.policies.AdjListView3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class AdjListView3EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public AdjListView3EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new AdjListView3ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AdjListViewText3EditPart) {
			((AdjListViewText3EditPart) childEditPart).setLabel(getPrimaryShape().getFigureAdjListViewLabelFigure());
			return true;
		}
		if (childEditPart instanceof AdjListViewAdjListViewLstAdjListViewColumnCompartment3EditPart) {
			IFigure pane = getPrimaryShape().getAdjListViewLstAdjListViewColumnCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((AdjListViewAdjListViewLstAdjListViewColumnCompartment3EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof AdjListViewAdjListViewLstAdjListViewColumnCompartment3EditPart) {
			IFigure pane = getPrimaryShape().getAdjListViewLstAdjListViewColumnCompartmentFigure();
			pane.remove(((AdjListViewAdjListViewLstAdjListViewColumnCompartment3EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof AdjListViewAdjListViewLstAdjListViewColumnCompartment3EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(AdjListViewText3EditPart.VISUAL_ID));
	}

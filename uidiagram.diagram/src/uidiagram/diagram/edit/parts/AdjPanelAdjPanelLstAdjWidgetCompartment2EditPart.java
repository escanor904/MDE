...
import uidiagram.diagram.edit.policies.AdjPanelAdjPanelLstAdjWidgetCompartment2CanonicalEditPolicy;
import uidiagram.diagram.edit.policies.AdjPanelAdjPanelLstAdjWidgetCompartment2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class AdjPanelAdjPanelLstAdjWidgetCompartment2EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public AdjPanelAdjPanelLstAdjWidgetCompartment2EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.AdjPanelAdjPanelLstAdjWidgetCompartment2EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new AdjPanelAdjPanelLstAdjWidgetCompartment2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new AdjPanelAdjPanelLstAdjWidgetCompartment2CanonicalEditPolicy());
	}

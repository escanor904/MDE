...
import uidiagram.diagram.edit.policies.AdjButton4ItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class AdjButton4EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public AdjButton4EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new AdjButton4ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AdjButtonName4EditPart) {
			((AdjButtonName4EditPart) childEditPart).setLabel(getPrimaryShape().getFigureAdjButtonLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(AdjButtonName4EditPart.VISUAL_ID));
	}

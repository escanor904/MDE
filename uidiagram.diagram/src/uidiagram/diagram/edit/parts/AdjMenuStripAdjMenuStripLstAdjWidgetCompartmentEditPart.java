...
import uidiagram.diagram.edit.policies.AdjMenuStripAdjMenuStripLstAdjWidgetCompartmentCanonicalEditPolicy;
import uidiagram.diagram.edit.policies.AdjMenuStripAdjMenuStripLstAdjWidgetCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class AdjMenuStripAdjMenuStripLstAdjWidgetCompartmentEditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public AdjMenuStripAdjMenuStripLstAdjWidgetCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.AdjMenuStripAdjMenuStripLstAdjWidgetCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new AdjMenuStripAdjMenuStripLstAdjWidgetCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new AdjMenuStripAdjMenuStripLstAdjWidgetCompartmentCanonicalEditPolicy());
	}

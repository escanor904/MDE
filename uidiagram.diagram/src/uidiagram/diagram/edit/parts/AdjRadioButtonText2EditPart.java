 ...
 * @generated
 */
public class AdjRadioButtonText2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AdjRadioButtonText2EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = UidiagramParserProvider.getParser(UidiagramElementTypes.AdjRadioButton_3102, getParserElement(),
					UidiagramVisualIDRegistry
							.getType(uidiagram.diagram.edit.parts.AdjRadioButtonText2EditPart.VISUAL_ID));
		}
		return parser;
	}

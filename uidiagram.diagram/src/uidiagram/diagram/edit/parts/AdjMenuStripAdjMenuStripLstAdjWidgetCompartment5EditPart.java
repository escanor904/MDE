...
import uidiagram.diagram.edit.policies.AdjMenuStripAdjMenuStripLstAdjWidgetCompartment5CanonicalEditPolicy;
import uidiagram.diagram.edit.policies.AdjMenuStripAdjMenuStripLstAdjWidgetCompartment5ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class AdjMenuStripAdjMenuStripLstAdjWidgetCompartment5EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public AdjMenuStripAdjMenuStripLstAdjWidgetCompartment5EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.AdjMenuStripAdjMenuStripLstAdjWidgetCompartment5EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new AdjMenuStripAdjMenuStripLstAdjWidgetCompartment5ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new AdjMenuStripAdjMenuStripLstAdjWidgetCompartment5CanonicalEditPolicy());
	}

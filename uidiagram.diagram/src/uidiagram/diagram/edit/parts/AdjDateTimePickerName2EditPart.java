 ...
 * @generated
 */
public class AdjDateTimePickerName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AdjDateTimePickerName2EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = UidiagramParserProvider.getParser(UidiagramElementTypes.AdjDateTimePicker_3101, getParserElement(),
					UidiagramVisualIDRegistry
							.getType(uidiagram.diagram.edit.parts.AdjDateTimePickerName2EditPart.VISUAL_ID));
		}
		return parser;
	}

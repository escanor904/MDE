 ...
 * @generated
 */
public class AdjCheckedListBoxNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AdjCheckedListBoxNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = UidiagramParserProvider.getParser(UidiagramElementTypes.AdjCheckedListBox_3007, getParserElement(),
					UidiagramVisualIDRegistry
							.getType(uidiagram.diagram.edit.parts.AdjCheckedListBoxNameEditPart.VISUAL_ID));
		}
		return parser;
	}

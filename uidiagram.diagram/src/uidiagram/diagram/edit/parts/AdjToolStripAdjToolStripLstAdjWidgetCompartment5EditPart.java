...
import uidiagram.diagram.edit.policies.AdjToolStripAdjToolStripLstAdjWidgetCompartment5CanonicalEditPolicy;
import uidiagram.diagram.edit.policies.AdjToolStripAdjToolStripLstAdjWidgetCompartment5ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class AdjToolStripAdjToolStripLstAdjWidgetCompartment5EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public AdjToolStripAdjToolStripLstAdjWidgetCompartment5EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.AdjToolStripAdjToolStripLstAdjWidgetCompartment5EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new AdjToolStripAdjToolStripLstAdjWidgetCompartment5ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new AdjToolStripAdjToolStripLstAdjWidgetCompartment5CanonicalEditPolicy());
	}

...
import uidiagram.diagram.edit.policies.AdjListViewAdjListViewLstAdjListViewColumnCompartmentCanonicalEditPolicy;
import uidiagram.diagram.edit.policies.AdjListViewAdjListViewLstAdjListViewColumnCompartmentItemSemanticEditPolicy;
...
public class AdjListViewAdjListViewLstAdjListViewColumnCompartmentEditPart extends ListCompartmentEditPart {
	...
	* @generated
	*/
	public AdjListViewAdjListViewLstAdjListViewColumnCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new AdjListViewAdjListViewLstAdjListViewColumnCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new AdjListViewAdjListViewLstAdjListViewColumnCompartmentCanonicalEditPolicy());
	}

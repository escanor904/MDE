...
import uidiagram.diagram.edit.policies.AdjToolStripAdjToolStripLstAdjWidgetCompartment4CanonicalEditPolicy;
import uidiagram.diagram.edit.policies.AdjToolStripAdjToolStripLstAdjWidgetCompartment4ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class AdjToolStripAdjToolStripLstAdjWidgetCompartment4EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public AdjToolStripAdjToolStripLstAdjWidgetCompartment4EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.AdjToolStripAdjToolStripLstAdjWidgetCompartment4EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new AdjToolStripAdjToolStripLstAdjWidgetCompartment4ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new AdjToolStripAdjToolStripLstAdjWidgetCompartment4CanonicalEditPolicy());
	}

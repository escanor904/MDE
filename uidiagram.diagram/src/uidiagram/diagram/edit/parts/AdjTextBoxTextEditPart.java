 ...
 * @generated
 */
public class AdjTextBoxTextEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AdjTextBoxTextEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UidiagramParserProvider.getParser(UidiagramElementTypes.AdjTextBox_3006, getParserElement(),
					UidiagramVisualIDRegistry.getType(uidiagram.diagram.edit.parts.AdjTextBoxTextEditPart.VISUAL_ID));
		}
		return parser;
	}

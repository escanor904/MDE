...
import uidiagram.diagram.edit.policies.AdjPictureBoxItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class AdjPictureBoxEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public AdjPictureBoxEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new AdjPictureBoxItemSemanticEditPolicy());
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new AdjPictureBoxFigure();
	}

	/**
	* @generated
	*/
	public AdjPictureBoxFigure getPrimaryShape() {
		return (AdjPictureBoxFigure) primaryShape;
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AdjPictureBoxTextEditPart) {
			((AdjPictureBoxTextEditPart) childEditPart).setLabel(getPrimaryShape().getFigureAdjPictureBoxLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(AdjPictureBoxTextEditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class AdjPictureBoxFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureAdjPictureBoxLabelFigure;

		/**
		 * @generated
		 */
		public AdjPictureBoxFigure() {
		...
		private void createContents() {
			...
			fFigureAdjPictureBoxLabelFigure = new WrappingLabel();

			fFigureAdjPictureBoxLabelFigure.setText("AdjPictureBox");

			this.add(fFigureAdjPictureBoxLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureAdjPictureBoxLabelFigure() {
			return fFigureAdjPictureBoxLabelFigure;
		}

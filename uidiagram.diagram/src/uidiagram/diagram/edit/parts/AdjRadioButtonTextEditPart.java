 ...
 * @generated
 */
public class AdjRadioButtonTextEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AdjRadioButtonTextEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = UidiagramParserProvider.getParser(UidiagramElementTypes.AdjRadioButton_3099, getParserElement(),
					UidiagramVisualIDRegistry
							.getType(uidiagram.diagram.edit.parts.AdjRadioButtonTextEditPart.VISUAL_ID));
		}
		return parser;
	}

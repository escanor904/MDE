...
import uidiagram.diagram.edit.policies.AdjGroupBoxAdjGroupBoxLstAdjWidgetCompartment4CanonicalEditPolicy;
import uidiagram.diagram.edit.policies.AdjGroupBoxAdjGroupBoxLstAdjWidgetCompartment4ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class AdjGroupBoxAdjGroupBoxLstAdjWidgetCompartment4EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public AdjGroupBoxAdjGroupBoxLstAdjWidgetCompartment4EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.AdjGroupBoxAdjGroupBoxLstAdjWidgetCompartment4EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new AdjGroupBoxAdjGroupBoxLstAdjWidgetCompartment4ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new AdjGroupBoxAdjGroupBoxLstAdjWidgetCompartment4CanonicalEditPolicy());
	}

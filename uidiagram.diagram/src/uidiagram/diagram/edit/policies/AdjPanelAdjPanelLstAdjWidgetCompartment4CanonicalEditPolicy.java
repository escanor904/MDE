 ...
 * @generated
 */
public class AdjPanelAdjPanelLstAdjWidgetCompartment4CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAdjPanelAdjPanelLstAdjWidgetCompartment_7011SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAdjPanelAdjPanelLstAdjWidgetCompartment_7011SemanticChildren((View) getHost().getModel());

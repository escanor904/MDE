 ...
 * @generated
 */
public class AdjToolStripAdjToolStripLstAdjWidgetCompartment4CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAdjToolStripAdjToolStripLstAdjWidgetCompartment_7023SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAdjToolStripAdjToolStripLstAdjWidgetCompartment_7023SemanticChildren((View) getHost().getModel());

 ...
 * @generated
 */
public class AdjMenuStripAdjMenuStripLstAdjWidgetCompartment4CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAdjMenuStripAdjMenuStripLstAdjWidgetCompartment_7021SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAdjMenuStripAdjMenuStripLstAdjWidgetCompartment_7021SemanticChildren((View) getHost().getModel());

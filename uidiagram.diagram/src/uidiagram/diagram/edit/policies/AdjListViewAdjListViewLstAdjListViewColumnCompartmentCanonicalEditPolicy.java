 ...
 * @generated
 */
public class AdjListViewAdjListViewLstAdjListViewColumnCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAdjListViewAdjListViewLstAdjListViewColumnCompartment_7027SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAdjListViewAdjListViewLstAdjListViewColumnCompartment_7027SemanticChildren(

 ...
 * @generated
 */
public class AdjToolStripAdjToolStripLstAdjWidgetCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return UidiagramPackage.eINSTANCE.getAdjToolStrip_LstAdjWidget();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAdjToolStripAdjToolStripLstAdjWidgetCompartment_7019SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAdjToolStripAdjToolStripLstAdjWidgetCompartment_7019SemanticChildren((View) getHost().getModel());

 ...
 * @generated
 */
public class AdjGroupBoxAdjGroupBoxLstAdjWidgetCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return UidiagramPackage.eINSTANCE.getAdjGroupBox_LstAdjWidget();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAdjGroupBoxAdjGroupBoxLstAdjWidgetCompartment_7015SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAdjGroupBoxAdjGroupBoxLstAdjWidgetCompartment_7015SemanticChildren((View) getHost().getModel());

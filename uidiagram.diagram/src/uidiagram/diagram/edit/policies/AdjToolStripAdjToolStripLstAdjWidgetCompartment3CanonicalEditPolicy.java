 ...
 * @generated
 */
public class AdjToolStripAdjToolStripLstAdjWidgetCompartment3CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAdjToolStripAdjToolStripLstAdjWidgetCompartment_7022SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAdjToolStripAdjToolStripLstAdjWidgetCompartment_7022SemanticChildren((View) getHost().getModel());

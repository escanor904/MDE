...
import uidiagram.diagram.part.UidiagramDiagramEditorUtil;
	...
	private static class OpenDiagramCommand extends AbstractTransactionalCommand {
						...
						try {
							for (Iterator it = diagramFacet.eResource().getResourceSet().getResources().iterator(); it
								...
								if (nextResource.isLoaded() && !getEditingDomain().isReadOnly(nextResource)) {
									nextResource.save(UidiagramDiagramEditorUtil.getSaveOptions());
								}
							}
		...
		*/
		protected String getDiagramKind() {
			return UIDiagramEditPart.MODEL_ID;
		}
		...
		*/
		protected String getEditorID() {
			return UidiagramDiagramEditor.ID;
		}
	}

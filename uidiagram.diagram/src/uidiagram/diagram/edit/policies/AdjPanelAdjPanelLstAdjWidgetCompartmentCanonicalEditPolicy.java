 ...
 * @generated
 */
public class AdjPanelAdjPanelLstAdjWidgetCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAdjPanelAdjPanelLstAdjWidgetCompartment_7003SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAdjPanelAdjPanelLstAdjWidgetCompartment_7003SemanticChildren((View) getHost().getModel());

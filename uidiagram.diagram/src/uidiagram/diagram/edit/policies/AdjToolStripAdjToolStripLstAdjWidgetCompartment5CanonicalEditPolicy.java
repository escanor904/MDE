 ...
 * @generated
 */
public class AdjToolStripAdjToolStripLstAdjWidgetCompartment5CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAdjToolStripAdjToolStripLstAdjWidgetCompartment_7026SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAdjToolStripAdjToolStripLstAdjWidgetCompartment_7026SemanticChildren((View) getHost().getModel());

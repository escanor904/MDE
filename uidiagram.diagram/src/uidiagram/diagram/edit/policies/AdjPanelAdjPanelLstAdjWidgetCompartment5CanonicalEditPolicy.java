 ...
 * @generated
 */
public class AdjPanelAdjPanelLstAdjWidgetCompartment5CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAdjPanelAdjPanelLstAdjWidgetCompartment_7014SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAdjPanelAdjPanelLstAdjWidgetCompartment_7014SemanticChildren((View) getHost().getModel());

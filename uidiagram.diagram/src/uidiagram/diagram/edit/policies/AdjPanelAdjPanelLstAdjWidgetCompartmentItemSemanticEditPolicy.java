 ...
 * @generated
 */
public class AdjPanelAdjPanelLstAdjWidgetCompartmentItemSemanticEditPolicy extends UidiagramBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public AdjPanelAdjPanelLstAdjWidgetCompartmentItemSemanticEditPolicy() {
		super(UidiagramElementTypes.AdjPanel_3015);
	}
	...
	*/
	protected Command getCreateCommand(CreateElementRequest req) {
		...
		if (UidiagramElementTypes.AdjPictureBox_3103 == req.getElementType()) {

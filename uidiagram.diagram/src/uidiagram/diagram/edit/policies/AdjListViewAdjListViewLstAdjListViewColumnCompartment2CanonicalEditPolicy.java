 ...
 * @generated
 */
public class AdjListViewAdjListViewLstAdjListViewColumnCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return UidiagramPackage.eINSTANCE.getAdjListView_LstAdjListViewColumn();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAdjListViewAdjListViewLstAdjListViewColumnCompartment_7028SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return AdjListViewColumnEditPart.VISUAL_ID == UidiagramVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAdjListViewAdjListViewLstAdjListViewColumnCompartment_7028SemanticChildren(

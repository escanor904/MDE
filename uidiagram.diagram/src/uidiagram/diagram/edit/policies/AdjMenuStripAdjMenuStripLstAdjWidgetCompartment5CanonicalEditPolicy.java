 ...
 * @generated
 */
public class AdjMenuStripAdjMenuStripLstAdjWidgetCompartment5CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAdjMenuStripAdjMenuStripLstAdjWidgetCompartment_7025SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAdjMenuStripAdjMenuStripLstAdjWidgetCompartment_7025SemanticChildren((View) getHost().getModel());

 ...
 * @generated
 */
public class AdjToolStripAdjToolStripLstAdjWidgetCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAdjToolStripAdjToolStripLstAdjWidgetCompartment_7012SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAdjToolStripAdjToolStripLstAdjWidgetCompartment_7012SemanticChildren((View) getHost().getModel());

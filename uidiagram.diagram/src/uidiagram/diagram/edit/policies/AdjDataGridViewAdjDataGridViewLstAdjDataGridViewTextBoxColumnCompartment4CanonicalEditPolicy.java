 ...
 * @generated
 */
public class AdjDataGridViewAdjDataGridViewLstAdjDataGridViewTextBoxColumnCompartment4CanonicalEditPolicy
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return UidiagramPackage.eINSTANCE.getAdjDataGridView_LstAdjDataGridViewTextBoxColumn();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAdjDataGridViewAdjDataGridViewLstAdjDataGridViewTextBoxColumnCompartment_7010SemanticChildren(
						viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return AdjDataGridViewTextBoxColumnEditPart.VISUAL_ID == UidiagramVisualIDRegistry.getVisualID(view);
	}

 ...
 * @generated
 */
public class AdjMenuStripAdjMenuStripLstAdjWidgetCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAdjMenuStripAdjMenuStripLstAdjWidgetCompartment_7017SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAdjMenuStripAdjMenuStripLstAdjWidgetCompartment_7017SemanticChildren((View) getHost().getModel());

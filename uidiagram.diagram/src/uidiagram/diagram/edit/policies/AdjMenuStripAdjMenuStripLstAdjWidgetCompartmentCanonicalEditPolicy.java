 ...
 * @generated
 */
public class AdjMenuStripAdjMenuStripLstAdjWidgetCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAdjMenuStripAdjMenuStripLstAdjWidgetCompartment_7009SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAdjMenuStripAdjMenuStripLstAdjWidgetCompartment_7009SemanticChildren((View) getHost().getModel());

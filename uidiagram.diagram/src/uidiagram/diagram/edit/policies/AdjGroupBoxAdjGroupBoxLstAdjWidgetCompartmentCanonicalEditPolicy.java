 ...
 * @generated
 */
public class AdjGroupBoxAdjGroupBoxLstAdjWidgetCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAdjGroupBoxAdjGroupBoxLstAdjWidgetCompartment_7006SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAdjGroupBoxAdjGroupBoxLstAdjWidgetCompartment_7006SemanticChildren((View) getHost().getModel());

 ...
 * @generated
 */
public class AdjPanelAdjPanelLstAdjWidgetCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAdjPanelAdjPanelLstAdjWidgetCompartment_7005SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAdjPanelAdjPanelLstAdjWidgetCompartment_7005SemanticChildren((View) getHost().getModel());

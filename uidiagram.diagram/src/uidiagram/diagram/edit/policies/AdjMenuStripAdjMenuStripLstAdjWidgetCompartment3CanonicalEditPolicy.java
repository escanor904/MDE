 ...
 * @generated
 */
public class AdjMenuStripAdjMenuStripLstAdjWidgetCompartment3CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return UidiagramPackage.eINSTANCE.getAdjMenuStrip_LstAdjWidget();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAdjMenuStripAdjMenuStripLstAdjWidgetCompartment_7020SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAdjMenuStripAdjMenuStripLstAdjWidgetCompartment_7020SemanticChildren((View) getHost().getModel());

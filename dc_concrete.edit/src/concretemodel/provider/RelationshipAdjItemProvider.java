...
/**
 * This is the item provider adapter for a {@link concretemodel.RelationshipAdj} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RelationshipAdjItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addClassSourcePropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConcretemodelPackage.Literals.RELATIONSHIP_ADJ__ROLE_TARGET,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConcretemodelPackage.Literals.RELATIONSHIP_ADJ__ROLE_SOURCE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConcretemodelPackage.Literals.RELATIONSHIP_ADJ__MULTIPLICITY_TARGET_CLASS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConcretemodelPackage.Literals.RELATIONSHIP_ADJ__MULTIPLICITY_SOURCE_CLASS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Class Source feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addClassSourcePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RelationshipAdj_classSource_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RelationshipAdj_classSource_feature", "_UI_RelationshipAdj_type"),
				 ConcretemodelPackage.Literals.RELATIONSHIP_ADJ__CLASS_SOURCE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addClassTargetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RelationshipAdj_classTarget_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RelationshipAdj_classTarget_feature", "_UI_RelationshipAdj_type"),
				 ConcretemodelPackage.Literals.RELATIONSHIP_ADJ__CLASS_TARGET,
				 true,
				 false,
				 true,
				 null,

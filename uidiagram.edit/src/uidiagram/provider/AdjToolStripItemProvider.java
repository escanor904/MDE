...
/**
 * This is the item provider adapter for a {@link uidiagram.AdjToolStrip} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AdjToolStripItemProvider extends AdjWidgetItemProvider {
	/**
	 ...
	 * @generated
	 */
	public AdjToolStripItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AdjToolStrip_font_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AdjToolStrip_font_feature", "_UI_AdjToolStrip_type"),
				 UidiagramPackage.Literals.ADJ_TOOL_STRIP__FONT,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UidiagramPackage.Literals.ADJ_TOOL_STRIP__LST_ADJ_WIDGET);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AdjToolStrip"));
	}
	...
	public String getText(Object object) {
		String label = ((AdjToolStrip)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_AdjToolStrip_type") :
			getString("_UI_AdjToolStrip_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AdjToolStrip.class)) {
			case UidiagramPackage.ADJ_TOOL_STRIP__FONT:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case UidiagramPackage.ADJ_TOOL_STRIP__LST_ADJ_WIDGET:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UidiagramPackage.Literals.ADJ_TOOL_STRIP__LST_ADJ_WIDGET,

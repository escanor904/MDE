...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Adj Tool Strip</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link uidiagram.impl.AdjToolStripImpl#getFont <em>Font</em>}</li>
 *   <li>{@link uidiagram.impl.AdjToolStripImpl#getLstAdjWidget <em>Lst Adj Widget</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AdjToolStripImpl extends AdjWidgetImpl implements AdjToolStrip {
	/**
	...
	protected EClass eStaticClass() {
		return UidiagramPackage.Literals.ADJ_TOOL_STRIP;
	}
	...
	public void setFont(String newFont) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UidiagramPackage.ADJ_TOOL_STRIP__FONT, oldFont, font));
	}
	...
	public EList<AdjWidget> getLstAdjWidget() {
		if (lstAdjWidget == null) {
			lstAdjWidget = new EObjectContainmentEList<AdjWidget>(AdjWidget.class, this, UidiagramPackage.ADJ_TOOL_STRIP__LST_ADJ_WIDGET);
		}
		return lstAdjWidget;
	}

...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Adj Group Box</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class AdjGroupBoxImpl extends AdjWidgetImpl implements AdjGroupBox {
	...
	public EList<AdjWidget> getLstAdjWidget() {
		if (lstAdjWidget == null) {
			lstAdjWidget = new EObjectContainmentEList<AdjWidget>(AdjWidget.class, this, UidiagramPackage.ADJ_GROUP_BOX__LST_ADJ_WIDGET);
		}
		return lstAdjWidget;
	}

 ...
 * </p>
 * <ul>
 *   <li>{@link uidiagram.impl.AdjPanelImpl#getFont <em>Font</em>}</li>
...
public class AdjPanelImpl extends AdjWidgetImpl implements AdjPanel {
	...
	public void setFont(String newFont) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UidiagramPackage.ADJ_PANEL__FONT, oldFont, font));
	}
